...
Currently warp blocks and magic lamps are illegal due to progression balancing, so they are re rolled into a legal item. NPCs still can use magic lamps, as the don't affect the player.